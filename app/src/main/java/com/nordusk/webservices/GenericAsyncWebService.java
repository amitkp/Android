...
/**
 * Created by NeeloyG on 1/6/2017.
 */

public class GenericAsyncWebService extends AsyncTask<Void, Void, Void> {
    ...
    public GenericAsyncWebService(Context context, String date, String sp_id) {
    ...
    private GenericAsyncWebService.OnContentListSchedules onContentListParserListner;

    public GenericAsyncWebService.OnContentListSchedules getOnContentListParserListner() {
        return onContentListParserListner;
    }

    public void setOnContentListParserListner(GenericAsyncWebService.OnContentListSchedules onContentListParserListner) {
