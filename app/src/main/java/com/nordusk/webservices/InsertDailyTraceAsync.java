 ...
 */
public class InsertDailyTraceAsync extends AsyncTask<Void, Void, Void> {
    ...
    public InsertDailyTraceAsync(Activity context, JSONObject jsonObject) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            String[] responsedata = HttpConnectionUrl.post(context, context.getResources().getString(R.string.base_url) +"insert_trace_sql.php?", jsonObject);
