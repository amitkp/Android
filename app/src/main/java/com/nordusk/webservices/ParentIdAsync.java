 ...
 */
public class ParentIdAsync extends AsyncTask<Void, Void, Void> {
    ...
    public ParentIdAsync(Activity context) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            String[] responsedata = HttpConnectionUrl.post(context, context.getResources().getString(R.string.base_url) + "distributer_name_suggest.php?", jsonObject);
