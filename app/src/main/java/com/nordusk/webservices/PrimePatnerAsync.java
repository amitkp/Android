 ...
 */
public class PrimePatnerAsync extends AsyncTask<Void, Void, Void> {
    ...
    public PrimePatnerAsync(Activity context) {
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            String[] responsedata = HttpConnectionUrl.post(context, context.getResources().getString(R.string.base_url) + "pp_name_suggest.php?", jsonObject);
